 ...
 *
 */
#ifndef PULSE_LKF_VELOCITY_CLASS_HPP
#define PULSE_LKF_VELOCITY_CLASS_HPP
...
namespace pulse_est
{
class LkfVelocity : public LinearKalmanFilter
{
public:
  /**
   *
   ...
   *
   * \arg[in] x_in Input velocity to be used to initialize LKF
   *
   */
  LkfVelocity(Eigen::Vector3d x_in, double smooth_coeff);
...
#endif /* PULSE_LKF_VELOCITY_CLASS_HPP */
