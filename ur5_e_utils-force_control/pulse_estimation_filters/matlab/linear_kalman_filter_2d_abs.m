...
figure(1);
output_img_file_name = fullfile(output_img_dir_name, 'lkf_2d_abs_track.png');
fprintf(['Saving file ''', output_img_file_name, '''...\n']);
saveas(gcf, output_img_file_name);

figure(2);
output_img_file_name = fullfile(output_img_dir_name, 'lkf_2d_abs_x.png');
fprintf(['Saving file ''', output_img_file_name, '''...\n']);
saveas(gcf, output_img_file_name);

figure(3);
output_img_file_name = fullfile(output_img_dir_name, 'lkf_2d_abs_y.png');
fprintf(['Saving file ''', output_img_file_name, '''...\n']);
saveas(gcf, output_img_file_name);
