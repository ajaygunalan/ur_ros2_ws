...
int main(int argc, char** argv)
{
  ...
  ros::init(argc, argv, "yoshikawa_standalone_force_control_node");
  ros::NodeHandle nh("~");
  ROS_DEBUG("yoshikawa_standalone_force_control_node - main");
  ...
  pfc::YoshikawaStandaloneForceControlClass y(nh);
