...
int main(int argc, char** argv)
{
  ...
  ros::ServiceClient grav_comp_client =
    n.serviceClient<netft_utils::SetBias>("/netft/gravity_comp");
  netft_utils::SetBias srv;
  srv.request.toBias = true;

  ROS_INFO("Sleeping prior to gravity compensation...");
  ros::Duration(10.0).sleep();

  if(grav_comp_client.call(srv))
  {
    ROS_INFO("Successfully initiated gravity compensation.");
  }
  else
  {
    ROS_ERROR("Gravity compensation initiation failed.");
  }
