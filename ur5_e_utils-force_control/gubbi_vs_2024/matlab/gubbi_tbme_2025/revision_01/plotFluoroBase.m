function [sys_c_pos_shifted] = plotCatheterBase(sys_ab_struct, sys_c_struct, input_time_vec, varargin)
	p = inputParser();
	...
	scatter(...
		1e3 .* robot_pos_shifted(:, 1), 1e3 .* robot_pos_shifted(:, 2), marker_size, ...
	...
	scatter(...
		1e3 .* sys_ab_pos_shifted(:, 1), 1e3 .* sys_ab_pos_shifted(:, 2), marker_size, ...
		'MarkerEdgeColor', color_order(real_time_color, :), 'MarkerFaceColor', color_order(real_time_color, :), ...
		'HandleVisibility', 'off');
	scatter(...
		1e3 .* sys_c_pos_shifted(:, 1), 1e3 .* sys_c_pos_shifted(:, 2), marker_size, ...
