...
sim_output_mat_file_name = fullfile(sim_output_mat_dir_name, sprintf('sim_%06d.mat', img_id));
...
output_img_file_name = fullfile(output_img_dir_name, 'res_qual.png');
