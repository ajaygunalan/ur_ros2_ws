...
for i0 = 1:length(phant_id_vec)
	p0 = phant_id_vec(i0);
	[phant_sys_ab_pos, phant_sys_c_pos] = computeLateralStatistics(...
...
for i0 = 1:length(vivo_id_vec)
	v0 = vivo_id_vec(i0);
	[vivo_sys_ab_pos, vivo_sys_c_pos] = computeLateralStatistics(...
...
output_img_file_name = fullfile(output_img_dir_name, 'res_pt_src_lat_dist.png');
