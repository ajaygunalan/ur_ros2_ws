function [sys_ab_ax_pos_probe, sys_c_ax_pos_probe] = computePointSourceStatisticsProbe(...
	...
	sys_ab_ax_pos_probe = sys_ab_struct.pt_src_p42v_link1(sys_ab_id_vec, :);
	sys_c_ax_pos_probe = sys_c_struct.pt_src_p42v_link1(sys_c_id_vec, :, end);
end
