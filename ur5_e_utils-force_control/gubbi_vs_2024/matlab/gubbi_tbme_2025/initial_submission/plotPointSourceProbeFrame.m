function plotPointSourceProbeFrame(sys_ab_struct, sys_c_struct, input_time_vec, output_img_file_base_name, varargin)
	...
	for i0 = 1:length(pt_src_coords_str_list)
		scatter(...
			sys_ab_struct.pt_src_time(sys_ab_id_vec), 1e3 .* sys_ab_struct.pt_src_p42v_link1(sys_ab_id_vec, i0), ...
			'.', 'DisplayName', 'System A/B');
		hold on
		scatter(...
			sys_c_struct.pt_src_time(sys_c_id_vec), 1e3 .* sys_c_struct.pt_src_p42v_link1(sys_c_id_vec, i0, end), ...
